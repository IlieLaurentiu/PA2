...
plt.plot([60, 120], [50, 20], linewidth=0.5, color='k')
plt.arrow(40, 60, 17, -8.5, head_length=3, head_width=2, color='b')
plt.arrow(44, 70, -0.5, 0, head_length=2, head_width=1.5, color='k')
plt.plot([73, 40], [70, 70], linewidth=0.5, color='k')
plt.arrow(117.5, 70, 0.5, 0, head_length=2, head_width=1.5, color='k')
plt.plot([87, 118], [70, 70], linewidth=0.5, color='k')

plt.plot([63, 120], [60, 60], linewidth=1, color='k')
plt.plot([120, 120], [60, 20], linewidth=1, color='k')
plt.plot([40, 60], [60, 60], linewidth=1, color='k')
plt.plot([60, 60], [60, 50], linewidth=1, color='k')
plt.plot([39, 30], [58, 40], linewidth=0.5, color='k')
plt.plot([119, 110], [18, 0], linewidth=0.5, color='k')
...
plt.arrow(130, 22.5, 0, -0.5, head_length=2, head_width=1.5, color='k')
plt.arrow(130, 58, 0, 0.5, head_length=2, head_width=1.5, color='k')

plt.plot([68, 32], [26.5, 44.3], linewidth=0.5, color='k')
plt.plot([77, 112], [22, 4], linewidth=0.5, color='k')
